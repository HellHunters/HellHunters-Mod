package com.hellhunters.hellhunters.registers;

import com.hellhunters.hellhunters.items.*;
...
@GameRegistry.ObjectHolder("hellhunters")
@Mod.EventBusSubscriber
public class ItemsRegistry
{
    private static final Item.ToolMaterial TEST_MATERIAL = EnumHelper.addToolMaterial("hellhunters:tool", 2, 256, 50.0F, 2.0F, 12);
